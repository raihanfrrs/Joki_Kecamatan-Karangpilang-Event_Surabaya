<form action="/request/event/{{ $model->slug }}" method="post" id="delete-form-{{ $model->slug }}">
    @csrf
    @method('delete')
    <a href="/request/event/{{ $model->slug }}/edit" class="text-decoration-none text-warning">
    ...
    <a href="/request/event/{{ $model->slug }}" class="text-decoration-none text-success">
        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
