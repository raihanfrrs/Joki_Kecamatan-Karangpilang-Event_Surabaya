<form action="request/{{ $model->id }}" method="post" id="delete-form-{{ $model->id }}">
    @csrf
    @method('delete')
    <a href="request/{{ $model->id }}/edit" class="text-decoration-none text-warning">
    ...
    <button type="submit" class="border-0 text-danger bg-white" id="delete-btn" data-key="{{ $model->id }}">
    ...
    <a href="request/{{ $model->id }}" class="text-decoration-none text-success">
        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
