<form action="musbangkel/{{ $model->slug }}" method="post" id="delete-form-{{ $model->slug }}" class="d-inline">
    @csrf
    @method('delete')
    <a href="musbangkel/{{ $model->slug }}/edit" class="text-decoration-none text-warning">
    ...
    <button type="submit" class="border-0 text-danger bg-white" id="delete-btn" data-key="{{ $model->slug }}">
        <svg style="width:24px;height:24px" viewBox="0 0 24 24" class="bg-white">
            <path fill="currentColor" d="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z" />
        </svg>
    </button>
    <a href="musbangkel/{{ $model->slug }}" class="text-decoration-none text-success">
        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
