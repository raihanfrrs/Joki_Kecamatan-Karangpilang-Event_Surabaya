              ...
              <form action="/profile/identity" method="POST">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="name" type="text" class="form-control" id="name" value="{{ auth()->user()->level == 'admin' ? auth()->user()->admin->name : auth()->user()->rukun_warga[0]->name }}">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="phone" type="text" class="form-control" id="phone" value="{{ auth()->user()->level == 'admin' ? auth()->user()->admin->phone : auth()->user()->rukun_warga[0]->phone }}">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="email" type="text" class="form-control" id="email" value="{{ auth()->user()->level == 'admin' ? auth()->user()->admin->email : auth()->user()->rukun_warga[0]->email }}">
                  </div>
                </div>
